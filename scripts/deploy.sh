...
chown socorro:socorro /home/socorro/primaryCrashStore /home/socorro/fallback
error $? "could not chown socorro on crash storage directories"
...
# TODO set up supervisord if needed
...
for service in nginx memcached supervisord
do
